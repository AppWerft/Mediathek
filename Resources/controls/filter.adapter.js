var Moment = require('vendor/moment'),
    ...
    URL = 'http://srv.deutschlandradio.de/aodlistaudio.1706.de.rpc?drau:page=PAGE&drau:limit=200&drau[broadcast_id]=ID';

const loadSendungen = function(id,page, onload) {
    var url = URL.replace('ID', id).replace('PAGE', page || '1');
